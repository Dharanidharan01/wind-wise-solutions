...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center overflow-hidden bg-background">
      ...
      <div className="absolute bottom-1/3 left-[5%] animate-float opacity-15" style={{
      animationDelay: '1s'
    }}>
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Headline */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in-up" style={{
            animationDelay: "0.1s"
          }}>
            ...
            {/* Subtext */}
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-10 animate-fade-in-up leading-relaxed" style={{
            animationDelay: "0.2s"
          }}>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 animate-fade-in-up" style={{
            animationDelay: "0.3s"
          }}>
              <Link to="/contact">
            ...
            {/* Mini stats */}
            <div className="flex items-center justify-center lg:justify-start gap-8 mt-12 animate-fade-in-up" style={{
            animationDelay: "0.4s"
          }}>
          ...
          animationDelay: "0.2s"
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-elevated hover-glow transition-all duration-500">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-border/50">
                <img src={heroImage} alt="Wind turbines generating clean renewable energy in green fields" className="w-full h-auto object-cover transition-transform duration-700 hover:scale-105" />
            ...
            {/* Floating stat card */}
            <div className="absolute -bottom-6 -left-6 bg-card p-4 rounded-xl shadow-elevated border border-border/50 animate-bounce-in" style={{
            animationDelay: "0.6s"
          }}>
            ...
            <div className="absolute -top-4 -right-4 bg-card p-4 rounded-xl shadow-elevated border border-border/50 animate-bounce-in" style={{
            animationDelay: "0.8s"
          }}>
              <div className="flex items-center gap-3">
        ...
        <div className="mt-20 pt-12 border-t border-border/50">
          ...
          }].map((stat, index) => <div key={index} className="text-center p-6 rounded-xl bg-card/50 border border-border/30 hover-lift animate-fade-in-up opacity-0" style={{
