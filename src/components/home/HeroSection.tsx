...
import { ArrowRight, Wind, Shield, Clock, ChevronDown, Sparkles } from "lucide-react";
...
const WindParticle = ({ delay, duration, top }: { delay: number; duration: number; top: string }) => (
  <div 
    className="absolute h-[2px] bg-gradient-to-r from-transparent via-accent/40 to-transparent animate-wind-flow" 
    style={{ top, left: 0, right: 0, animationDelay: `${delay}s`, animationDuration: `${duration}s` }} 
  />
);
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-background">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-background/40 to-background/50" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-8 animate-fade-in-down border border-primary/20 backdrop-blur-sm group hover:bg-primary/20 transition-all cursor-default">
              ...
              <span>Trusted Service for Wind Energy</span>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              ...
              <span className="block text-foreground">Service</span>
            </h1>
          ...
          <div className="hidden lg:block relative">
            <div className="grid grid-cols-2 gap-4">
              {/* Feature Card 1 */}
              <div className="p-6 rounded-2xl bg-card/80 backdrop-blur-md border border-border/50 hover-lift hover-glow animate-fade-in-up group cursor-pointer" style={{ animationDelay: "0.5s" }}>
                ...
                <h3 className="text-lg font-semibold mb-2 group-hover:text-primary transition-colors">Modern & Innovative</h3>
                <p className="text-sm text-muted-foreground">Cutting-edge technology for turbine performance optimization</p>
              </div>

              {/* Feature Card 2 */}
              <div className="p-6 rounded-2xl bg-card/80 backdrop-blur-md border border-border/50 hover-lift hover-glow animate-fade-in-up group cursor-pointer mt-8" style={{ animationDelay: "0.6s" }}>
                ...
                <p className="text-sm text-muted-foreground">Industry-certified engineers with 15+ years experience</p>
              </div>

              {/* Feature Card 3 */}
              <div className="p-6 rounded-2xl bg-card/80 backdrop-blur-md border border-border/50 hover-lift hover-glow animate-fade-in-up group cursor-pointer" style={{ animationDelay: "0.7s" }}>
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent/20 to-accent/5 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <Clock className="h-7 w-7 text-accent" />
                </div>
                <h3 className="text-lg font-semibold mb-2 group-hover:text-accent transition-colors">Rapid Response</h3>
                <p className="text-sm text-muted-foreground">Quick emergency support to minimize your downtime</p>
              </div>

              {/* Feature Card 4 */}
              <div className="p-6 rounded-2xl bg-card/80 backdrop-blur-md border border-border/50 hover-lift hover-glow animate-fade-in-up group cursor-pointer mt-8" style={{ animationDelay: "0.8s" }}>
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
